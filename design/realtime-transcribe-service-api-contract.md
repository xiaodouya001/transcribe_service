...
| Business structure of the value | The same validated business structure as the upstream request: `metaData + payload` |
| Server-added fields | None. The service does not append ACK, ERROR, `serverProcessingMs`, or a Kafka wrapper object |
