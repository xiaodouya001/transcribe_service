...
- 当 UI、测试、实现与 API 契约冲突时，以 `design/realtime-transcribe-service-api-contract.md` 为准。
...
- `design/realtime-transcribe-service-design-guardrails.md` 是长期维护基线。
- `design/realtime-transcribe-service-protocol-scenario-matrix.md` 是协议场景的唯一说明入口。
